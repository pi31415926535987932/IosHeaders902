...
@property (nonatomic,readonly) SCD_Struct_UI32 serviceAuditToken; 
...
-(int)servicePID;
-(SCD_Struct_UI32)serviceAuditToken;
...
-(id)_initWithConnectionInfo:(SCD_Struct_UI85)arg1 service:(id)arg2 deputyInterfaces:(id)arg3 ;
-(id)_initWithConnectionInfo:(SCD_Struct_UI85)arg1 serviceBundleIdentifier:(id)arg2 service:(id)arg3 deputyInterfaces:(id)arg4 ;
@end
