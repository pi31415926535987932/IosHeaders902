...
+(char)_enabled;
+(id)lightweightFactoryForVisualStyle:(SCD_Struct_UI35)arg1 renderConfig:(id)arg2 ;
+(id)factoryForVisualStyle:(SCD_Struct_UI35)arg1 renderConfig:(id)arg2 skipLayoutSegments:(char)arg3 ;
+(id)factoryForVisualStyle:(SCD_Struct_UI35)arg1 renderConfig:(id)arg2 ;
