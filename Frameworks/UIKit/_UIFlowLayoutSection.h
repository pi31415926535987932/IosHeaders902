...
@interface _UIFlowLayoutSection : NSObject {
	...
	SCD_Struct_UI87 _rowAlignmentOptions;
...
@property (assign,nonatomic) SCD_Struct_UI87 rowAlignmentOptions;                //@synthesize rowAlignmentOptions=_rowAlignmentOptions - In the implementation block
...
-(int)itemsByRowCount;
-(int)itemsCount;
-(SCD_Struct_UI87)rowAlignmentOptions;
...
-(void)setRowAlignmentOptions:(SCD_Struct_UI87)arg1 ;
