...
-(id)imageNamed:(id)arg1 scale:(float)arg2 idiom:(int)arg3 subtype:(unsigned)arg4 cachingOptions:(unsigned)arg5 sizeClassPair:(SCD_Struct_UI30)arg6 attachCatalogImage:(char)arg7 ;
