...
@class UIBezierPath, UITraitCollection, NSMutableArray, CALayer, NSArray, UIViewController, NSString, UIColor, UILayoutGuide, NSISVariable, NSISEngine, UIPresentationController, NSLayoutXAxisAnchor, NSLayoutYAxisAnchor, NSLayoutDimension, _UITouchForceObservable, UIKBRenderConfig;
