...
-(SCD_Struct_NS13)_minimumRangeOfUnit:(unsigned)arg1 ;
-(SCD_Struct_NS13)_maximumRangeOfUnit:(unsigned)arg1 ;
-(SCD_Struct_NS13)_rangeOfUnit:(unsigned)arg1 inUnit:(unsigned)arg2 forAT:(double)arg3 ;
