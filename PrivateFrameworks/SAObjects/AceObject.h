...
#import <assistantd/ADThunking.h>
...
@interface AceObject : NSObject <ADThunking, AceObject> {
...
-(void)_ad_setPayloadOnRequestInfo:(id)arg1 ;
-(char)ad_transcriptionResultRequiresAddressBook;
-(id)ad_transcriptionResultWithAddressBook:(id)arg1 ;
-(void)ad_invokeThunk;
-(id)_adspeech_userDataWithLocale:(id)arg1 ;
-(id)_adspeech_templateName;
